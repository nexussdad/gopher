...
![](../01-Gin框架/images/02-路由配置/2_go_1.png)

访问后，直接返回数据，不走签名验证。

访问 v2 接口：

![](../01-Gin框架/images/02-路由配置/2_go_2.png)
...
![](../01-Gin框架/images/02-路由配置/2_go_3.png)
...
![](../01-Gin框架/images/02-路由配置/2_go_4.png)
